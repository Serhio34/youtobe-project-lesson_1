const switcher = document.querySelector('#cbx'),
      hum = document.querySelectorAll('.hamburger > line'),
...
function switchModeIf(){
    document.body.classList.add('night');
    document.querySelectorAll('.hamburger > line').forEach(item => {
      item.classList.add('humswitch');
    });

    document.querySelectorAll('.videos__item-descr').forEach(item => {
      item.classList.add('descrswitch');
    });

    document.querySelectorAll('.videos__item-views').forEach(item => {
      item.classList.add('viewsswitch');
    });
...
function switchModeElse(){
    document.body.classList.remove('night');
    document.querySelectorAll('.hamburger > line').forEach(item => {
      item.classList.remove('humswitch');
    });
    document.querySelectorAll('.videos__item-descr').forEach(item => {
       item.classList.remove('descrswitch');
    }); 
    document.querySelectorAll('.videos__item-views').forEach(item => {
      item.classList.remove('viewsswitch');
    }); 
